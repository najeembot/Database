...
MongoC.connect(url, function(err, client){
    ...
    let obj = {_id:d_id, name:"Alex", Age:33, Date:(new Date())}
...
MongoC.connect(url, function(err, client) {
    ...
    let objm = [{_id:1, name:"Joseph", Age:33, Date:(new Date())},{_id:2, name:"Joseph", Age:33, Date:(new Date())},{_id:3, name:"Joseph", Age:33, Date:(new Date())}]
